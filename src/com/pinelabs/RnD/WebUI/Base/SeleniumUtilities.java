...
public class SeleniumUtilities {
    ...
    public void initialization() {
        ...
        //	            
           capability = acceptInsecureCert(capability);
...
//            }
	...
	/*
	 * Use this method to accept SSL errors which are asking for permission to
	 * navigate to a web page which is not secure
	 */
    
    
    public ChromeOptions acceptInsecureCert(ChromeOptions capability)
    {
    ...
    //Method for wait condition to wait for element
    
    public void waitUntilElementClickable(WebDriver driver, String locatorType, String locatorString) {
		//WebDriverWait wait = new WebDriverWait(driver, 30);
		if (locatorType.equalsIgnoreCase("id")) {
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(locatorString)));
		} else if (locatorType.equalsIgnoreCase("xpath")) {
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(locatorString)));
