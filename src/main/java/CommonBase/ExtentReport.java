...
public class ExtentReport {
    ...
    public static void initialiseReport() {
        ...
        htmlReporter = new ExtentHtmlReporter(Paths.extentReportPath + generateDynamicName() + ".html");
    ...
    public static void generateReport(ITestResult result) {
        ...
        if (result.getStatus() == ITestResult.FAILURE) {
            extentTestLogger.log(Status.FAIL, MarkupHelper.createLabel( "Test case failed due to : "
                    ...
                    + "Result.getNameeeeeeeeeeeeeeeeeeeeee" +result.getName()+" FAILED ", ExtentColor.RED));
